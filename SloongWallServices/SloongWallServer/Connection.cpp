...
bool CConnection::Open(CString ConnectionString,CString UserID,CString Password, ConnectOptionEnum ConnectOption)
{
	try
	{
		...
		{
			m_sErrorMessage="There is an error when open the connection!";
			return false;
		}
	}
    catch(_com_error e)
...
bool CConnection::Close()
{
	if(m_pConn==NULL)
	{
        m_sErrorMessage="Connectin is not available!";
		return true;
	}
	...
	try
	{
		...
		if(state==ObjectState::adStateOpen)
		{
			...
			{
				//m_sErrorMessage
				m_sErrorMessage="Failed to close the connection!";
				return false;
			}
...
bool  CConnection::CommitTrans()
{
	...
	try
	{
		...
		{
			//m_sErrorMessage
			m_sErrorMessage="Failed to commit the tranction!";
			return false;
		}
	}
	catch(_com_error e)
	{
		//m_sErrorMessage
		m_sErrorMessage="There is an error when called then function: CommitTrans()!";
		return false;	
	}
}
...
bool CConnection::RollbackTrans()
{
	...
	try
	{
		...
		{
			//m_sErrorMessage
			m_sErrorMessage="Failed to rollback the tranction!";
			return false;
		}
	}
	catch(_com_error e)
	{
		//m_sErrorMessage
		m_sErrorMessage="There is an error when called then function: RollbackTrans()!";
		return false;	
	}
